...
#   snp_coverage_file <- snp_coverage_fns[grepl("single_eigenstrat_coverage", snp_coverage_fns)]
# } else {
#   snp_coverage_file <- snp_coverage_fns[1]
# }
# 
...
snp_cov<-read_tsv(snp_coverage_file, col_names=c("#Sample", "#SNPs_Covered", "#SNPs_Total"), col_types='cii', skip=1) %>%
