...
credential_file <- path.expand(params$cred_file)
...
con <- get_pandora_connection(credential_file)
...
snp_cov<-read_tsv(snp_coverage, col_names=c("#Sample", "#SNPs_Covered", "#SNPs_Total"), col_types='cii', skip=1) %>%
...
sex_det <- read_tsv(sex_det_file, col_names=c("#Sample", "#SnpsAut", "#SNPsX", "#SnpsY", "NrAut", "NrX", "NrY", "x-rate", "y-rate"), col_types='ciiiiiidd', skip=1) %>%
...
sex_det <- read_tsv(sex_det_file, col_names=c("#Sample", "#SnpsAut", "#SNPsX", "#SnpsY", "NrAut", "NrX", "NrY", "x-rate", "y-rate", "Err(x-rate)", "Err(y-rate)"), col_types='ciiiiiidddd', skip=1) %>%
  separate(`#Sample`, into=c("Sample"), sep="[._]", extra='drop') %>%
