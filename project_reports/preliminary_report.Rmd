...
snp_cov<-read_tsv(snp_coverage, col_names=c("#Sample", "#SNPs_Covered", "#SNPs_Total"), col_types='cii') %>%
...
sex_det <- read_tsv(sex_det_file, col_names=c("#Sample", "#SnpsAut", "#SNPsX", "#SnpsY", "NrAut", "NrX", "NrY", "x-rate", "y-rate"), col_types='ciiiiiidd') %>%
...
sex_det <- sex_det <- read_tsv(sex_det_file, col_names=c("#Sample", "#SnpsAut", "#SNPsX", "#SnpsY", "NrAut", "NrX", "NrY", "x-rate", "y-rate"), col_types='ciiiiiidd') %>%
  separate(`#Sample`, into=c("Sample"), sep="[._]", extra='drop') %>%
